...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Year Published:");
        ...
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fiction", "Non-Fiction", "Textbook" }));
        ...
        updatePanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 110, 30));
        ...
        checkStockTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Name", "Author", "Stock", "Category"
            }
        ));
        ...
        stockStatusCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fiction", "Non-Fiction", "Textbook" }));
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fiction", "Non-Fiction", "Textbook" }));
    ...
    private void checkStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkStockButtonActionPerformed
            ...
            ArrayList<ProductList> list = FictionDB.checkStock();
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        // TODO add your handling code here:
        try{
            if(mCat.getSelectedItem().equals("Non-Fiction")){
            if(!path.equals(""))
                NonFictionDB.insertIntoMobileDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        
        else if(mCat.getSelectedItem().equals("Fiction")){
            if(!path.equals(""))
                FictionDB.insertIntoElectronicsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        else if(mCat.getSelectedItem().equals("Textbook")){
            if(!path.equals(""))
                TextbookDB.insertIntoKidsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
       ...
       try{
            ...
            if(stockStatusCat.getSelectedItem().equals("Fiction")){
                FictionDB.flag = true;
                FictionDB.updateElectronicsDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Non-Fiction")){
                NonFictionDB.flag = true;
                NonFictionDB.updateMobileDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Textbook")){
                TextbookDB.flag = true;
                TextbookDB.updateKidsDB(model, qty);
            }
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Fiction")){
            FictionDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Non-Fiction")){
            NonFictionDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Textbook")){
            TextbookDB.delete(del);
        }
