...
public class MainPage extends javax.swing.JFrame {
    ...
    public MainPage() {
        ...
        ArrayList<ProductList> list = FictionDB.homePageContent();
        ...
        for(int i=0; i<list.size(); i++){
            ...
            ImageIcon ii = new ImageIcon(getClass().getResource("/View/Icons&Images/"+temp));
        ...
        list = NonFictionDB.homePageContent();
        ...
        list = TextbookDB.homePageContent();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mushfiq's Bookstore");
        ...
        electronicsButton.setText("Fiction");
        ...
        mobilesButton.setText("Non-Fiction");
        ...
        homeTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Name", "Author", "Price", "Stock", "Year Published", "Photo"
            }
        ) {
    ...
    private void electronicsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_electronicsButtonActionPerformed
        // TODO add your handling code here:
        ProductInformation.categoryChooser = "fiction";
        ArrayList<ProductList> list = FictionDB.TableGenerator();
        Object rowData[] = new Object[6];
    ...
    private void mobilesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mobilesButtonActionPerformed
        // TODO add your handling code here:
        ProductInformation.categoryChooser = "non-fiction";
        ArrayList<ProductList> list = NonFictionDB.TableGenerator();
        String[] columnName = {};
        Object rowData[] = new Object[6];
    ...
    private void kidsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kidsButtonActionPerformed
        // TODO add your handling code here:
        ProductInformation.categoryChooser = "textbook";
        ArrayList<ProductList> list = TextbookDB.TableGenerator();
        Object rowData[] = new Object[6];
...
//        });
        ...
        newMain.setTitle("Mushfiq's Bookstore");
